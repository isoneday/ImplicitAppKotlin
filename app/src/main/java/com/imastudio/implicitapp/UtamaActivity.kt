...
import com.imastudio.implicitapp.ui.*
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_home -> {
                ...
                // Handle the camera action
                supportFragmentManager.beginTransaction()
                    .replace(R.id.container, AudioManagerFragment()).commit()
            }
            R.id.nav_audiorecorder -> {
                supportFragmentManager.beginTransaction()
                    .replace(R.id.container, AudioRecorderFragment()).commit()

            }
            R.id.nav_browser -> {
                supportFragmentManager.beginTransaction()
                    .replace(R.id.container, BrowserFragment()).commit()
            ...
            R.id.nav_email -> {
                supportFragmentManager.beginTransaction()
                    .replace(R.id.container, EmailFragment()).commit()
            ...
            R.id.nav_tts -> {
                supportFragmentManager.beginTransaction()
                    .replace(R.id.container, TTSFragment()).commit()
            ...
            R.id.nav_wifi -> {
                supportFragmentManager.beginTransaction()
                    .replace(R.id.container, WifiFragment()).commit()
